...
struct Colors {
    static let aqua             = UIColor(red: 0/255, green: 255/255, blue: 255/255, alpha: 1.0)
    static let darkPeach        = UIColor(red: 213/255, green: 100/255, blue: 70/255, alpha: 1.0)
    static let loginColorOne    = UIColor(red: 255.0/255.0, green: 236.0/255.0, blue: 210.0/255.0, alpha: 1.0)
    static let loginColorTwo    = UIColor(red: 252.0/255.0, green: 182.0/255.0, blue: 159.0/255.0, alpha: 1.0)
    ...
    static let bestBuyBlue      = UIColor(red: 0/255.0, green: 62.0/255.0, blue: 180.0/255.0, alpha: 1.0)
}
